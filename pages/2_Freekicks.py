...
if df.empty:
    st.warning("No freekick rows were found in Data/SWE SP.xlsx or Data/CZ SP.csv.")
    st.stop()
...
st.caption("Source: Data/SWE SP.xlsx and Data/CZ SP.csv filtered to From Free Kick. Sequence tables group rows by match_id, possession, and team.")
kpi_row(filtered)
